...
export class ShellSync {
  ...
  async performInitialSync() {
    try {
      ...
      this.store.setDesktopItems(desktopItems);
      ...
      this.store.setBootstrapping(false);
